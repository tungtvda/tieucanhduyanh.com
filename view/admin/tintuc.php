...
{
    return '<th>Id</th><th>Tên</th><th>Img</th><th>View</th><th>Created</th>';
}
//
...
function showFrom($form,$ListKey=array())
{
    ...
    $str_from.='<p hidden="hidden"><label>View</label><input class="text-input small-input" type="text"  name="View" value="'.(($form!=false)?$form->View:'').'" /></p>';
    ...
    $str_from.='<p hidden="hidden"><label>Created</label><input class="text-input small-input" type="text"  name="Created" value="'.(($form!=false)?$form->Created:'').'" /></p>';
    return $str_from;
}
?>
